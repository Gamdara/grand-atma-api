...
<body>
    <div class="p-5">
        ...
        <hr class="mt-4" />
        <h3 class="my-1 text-center font-bold">LAPORAN PENDAPATAN</h3>
        {{-- <hr class="mb-4" /> --}}
        <p class="my-4">Tahun {{$data['year']}}</p>
          ...
          <tbody>
            ...
            @foreach ($data['table'] as $key => $room)
                ...
                <tr class="text-center divide-y ">
                    ...
                    <td class="px-4  border border-slate-600 text-left">{{$room['month']}}</td>
                    <td class="px-4 text-right border border-slate-600">{{$room['group']}}</td>
                    <td class="px-4 text-right border border-slate-600">{{$room['personal']}}</td>
